...
public class LockTest {
    ...
    public void test_update_user_when_concurrent_with_no_timeout_throw_exception() throws Exception {
    ...
    @Test
    public void test_update_user_when_after_exception_than_true() {
        final MockUser user = new MockUser().setId("123456").setName("张三");
        try {
